class SellableInventoryUpdationJob
	...
	def self.fetch_sellable_inventory(steam_account) # Change to a class method
		new.fetch_sellable_inventory(steam_account) # Create an instance and call the method
	end
